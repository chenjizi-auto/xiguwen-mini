...
Page({
  ...
  onAddTap() {
    wx.navigateTo({
      url: `/packageWedding/pages/schedule/form?date=${encodeURIComponent(this.data.currentDate)}`
    })
  },
  ...
  onEditTap(e) {
    ...
    wx.navigateTo({
      url: `/packageWedding/pages/schedule/form?data=${encodeURIComponent(JSON.stringify(item))}`
    })
  },
